...
function DashboardCard(props) {
  return (
    <div className='card bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 w-64 h-28 rounded-xl flex items-center justify-around gap-2 hover:transition-transfor hover:scale-105 hover:duration-200 hover:ease-in-out'>
        <div className='flex flex-col items-left'>
            <h3 className='text-xl font-bold text-white'>{props.details.title}</h3>
