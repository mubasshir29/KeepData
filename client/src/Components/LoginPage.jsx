        ...
        <div className='bg-slate-700 w-1/2 rounded-2xl flex flex-row-reverse items-center justify-between'>
            ...
            <form className='flex flex-col gap-6 text-base text-white w-full'>
                <div className='w-full flex flex-col gap-2 mx-auto'>
                    ...
                    <input type='text' name='email' className='p-1 rounded-md bg-slate-800 flex-1 focus:outline-none' onChange={e=>valueChange(e)}></input>
                </div>
                <div className='flex flex-col gap-2 w-full mx-auto'>
                    <label className='text-base text-indigo-500'>Password</label>
                    <input type='password' name='password' className='p-1 rounded-md bg-slate-800 flex-1 focus:outline-none' onChange={e=>valueChange(e)}></input>
                </div>
            </form>
