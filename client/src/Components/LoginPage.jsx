...
function LoginPage() {
  ...
  return (
    <div className='fixed left-0 top-0 w-full h-screen bg-gray-500/70 z-20 flex flex-col items-center justify-center bg-transparent'>
        <div className='text-white text-5xl absolute top-5 right-5'><RxCrossCircled/></div>
        <div className='bg-slate-700 w-1/2 rounded-2xl flex flex-row-reverse items-center justify-between'>
            <div className='flex-1 flex flex-col items-center justify-center gap-1/2 bg-indigo-500 h-full px-12 rounded-r-2xl'>
                ...
                <p className='mt-6 text-sm text-slate-300 flex gap-2 items-center'>Don't have an account? <NavLink className=' border-solid border border-slate-300 rounded-full px-2 py-1 '><span className='text-slate-300'>Sign Up</span></NavLink></p>
            </div>
            ...
            <form className='flex flex-col gap-6 text-xl text-white w-full'>
                <div className='w-full flex flex-col gap-2 mx-auto'>
                    <label className='text-base text-indigo-500'>Email</label>
                    <input type='text' name='email' className='p-1 rounded-md bg-slate-800 flex-1' onChange={e=>valueChange(e)}></input>
                </div>
                <div className='flex flex-col gap-2 w-full mx-auto'>
                    <label className='text-base text-indigo-500'>Password</label>
                    <input type='password' name='password' className='p-1 rounded-md bg-slate-800 flex-1' onChange={e=>valueChange(e)}></input>
                </div>
            </form>
